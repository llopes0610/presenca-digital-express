  ...
  const handleClick = () => {
    ...
    if (typeof window !== 'undefined' && typeof window.gtag === 'function') {
      window.gtag('event', 'conversion', {
        send_to: 'AW-382161513/UKnjCNbj1tAbEOmknbYB',
      });
    }
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14
                 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-2xl
    ...
    >
      ...
      {/* Tooltip */}
      <span
        className="absolute right-full mr-3 px-3 py-2 bg-dark-900 text-white
                   text-sm rounded-lg whitespace-nowrap opacity-0
